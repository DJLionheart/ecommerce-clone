...
function ProductSocial(props) {
    return(
        <section className="product_social_links">
            <h4>SHARE</h4>
            <h1>Spread the word about { props.product.title }</h1>
            <span className="social_buttons">
                <a id="fb_button" href="https://www.facebook.com">
                    <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-facebook" viewBox="7.5 2019.5 7 13">
                ...
                <a id="pi_button" href="https://www.pinterest.com">
                    <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-pinterest" viewBox="0 0 1945 2500">
